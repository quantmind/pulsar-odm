...
class ModelDictionary(dict):
    ...
    def __contains__(self, model):
        return super().__contains__(self.meta(model))

    def __getitem__(self, model):
        return super().__getitem__(self.meta(model))

    def __setitem__(self, model, value):
        super().__setitem__(self.meta(model), value)

    def get(self, model, default=None):
        return super().get(self.meta(model), default)

    def pop(self, model, *args):
        return super().pop(self.meta(model), *args)
